...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/batches" element={<ProtectedRoute><AppLayout><BatchesPage /></AppLayout></ProtectedRoute>} />
      ...
      <Route path="/my-assignments" element={<ProtectedRoute><AppLayout><StudentAssignmentsPage /></AppLayout></ProtectedRoute>} />
